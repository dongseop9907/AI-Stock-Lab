...
import { runDailyRegimeBacktest } from "@/lib/backtest/run-daily-regime-backtest";
...
function getOptionalRegimeFilter(
  value: unknown,
):
  | "NONE"
  | "BLOCK_BEAR"
